            ...
            ?>
                <div class="right" style="padding: 10px 0;">
                    <a href="uploadSound/" target="_blank">
            			<button style="background:  #1b83e3; color:  white; padding:  8px 8px; border:  0px; border-radius:  3px;">Add Sound File</button>
                    </a>
                </div>
            <?php
        }
            ...
            ?>
                <div class="right" style="padding: 10px 0;">
                    <span onclick=addSoundSection();>
            			<button style="background:  #1b83e3; color:  white; padding:  8px 8px; border:  0px; border-radius:  3px;">Add Section</button>
                    </span>
                </div>
            <?php
        }
                				...
                				?>
                				    <div class="col25 left">
                	                    <div id='<?php echo $post_name[0];?>' style="text-align: center;margin-bottom: 8px; border: solid 1px lightgray;padding: 8px 5px;margin-right: 10px;border-radius: 3px;">
                    					    ...
                    					    <div onclick=submitSound('<?php echo $post_name[0];?>') style="background: #1b83e3;color: white;padding: 5px 0;border-radius: 3px;font-size: 11px;margin-top: 5px; width: 55px; float:left; ">
                    					        Publish
                    					    </div>
